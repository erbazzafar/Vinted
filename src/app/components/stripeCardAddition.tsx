	...
	return (
		<div className="w-full max-w-md mx-auto bg-white p-4 sm:p-8 rounded-xl shadow-lg">
			...
			<h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-6 flex items-center gap-2">
				<CreditCard className="text-indigo-600 w-5 h-5 sm:w-6 sm:h-6" />
				Payment Information
			</h2>
			...
			<div className="rounded-lg border border-gray-300 shadow-sm overflow-hidden focus-within:ring-2 focus-within:ring-indigo-500 focus-within:border-indigo-500 transition-all">
				...
				<div className="flex flex-col sm:flex-row">
					<div className="flex-1 px-4 py-3 sm:px-5 sm:py-4 border-b sm:border-b-0 sm:border-r border-gray-200 bg-white">
						<CardExpiryElement
							options={ELEMENT_OPTIONS}
							className="w-full text-gray-900 placeholder-gray-400 outline-none"
						/>
					</div>
					<div className="flex-1 px-4 py-3 sm:px-5 sm:py-4 bg-white">
						<CardCvcElement
							options={ELEMENT_OPTIONS}
							className="w-full text-gray-900 placeholder-gray-400 outline-none"
						/>
			...
			>
				{loading
					? "Processing..."
					: `Pay AED ${Number(formData.subTotal).toFixed(2)}`}
			</button>
